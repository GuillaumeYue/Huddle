...
- **Phase 3 labs complete.** Next gate: the "definition of present" decision (roster snapshot + epoch vs live denominator) MUST be settled before any phase-4 tally code. The inactivity timer / distributed-timer lab sits at the phase-4 boundary.
