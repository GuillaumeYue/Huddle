...
- **Phase 3 remaining:** (3) presence + disconnect handling (feeds the unresolved "present" definition, which MUST be settled before phase-4 tally code). The inactivity timer / distributed-timer lab also still ahead (phase 4 boundary).
