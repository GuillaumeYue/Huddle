...
- **Phase 4 remaining:** overtime rounds (round bump + fresh/relaxed deck + re-frozen roster, hard cap), user-tapped blind pick UI, tally/vote summary on the reveal screen. Then phase 5 (Google Places provider).
