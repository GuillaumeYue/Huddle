...
- **Phase 6 remaining:** fairness default decision (average vs least-misery — discuss, Alex decides), 6.3 learn-from-outcomes (weight MATCHED winners), maybe surface "why this card" in UI. Then phase 7 durability + history.
